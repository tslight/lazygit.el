...
#+AUTHOR: Toby Slight
#+STARTUP: overview
(setq lazygitlab-directory "~/src")
* Overview

  Ever setup up a new machine and just wanted to clone all your GitHub repos or
  GitLab projects (or groups) quickly and easily from the comfort of Emacs?

  Lazygit to the rescue...

  [[./img/clone.png]]

  Ever been multi-tasking like a mofo, and wondered how much work you hadn't
