...
Ever wanted to clone *ALL* of your GitHub repos or GitLab projects (or groups)
quickly and easily from the comfort of Emacs?
...
Ever wished you could just quickly update *ALL* the Git repos on your machine in
one fail swoop with an Emacs command?
