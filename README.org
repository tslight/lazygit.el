...
Results of running ~(github/retriever "user/torvalds")~ when [[https://github.com/DamienCassou/json-navigator][json-navigator]] is
installed:
...
Results of running ~(github/retriever "user/torvalds")~ when [[https://github.com/DamienCassou/json-navigator][json-navigator]] is not
installed:
